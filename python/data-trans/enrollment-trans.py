...
def format_fixed_width(record):
    formatted_record = ''
    formatted_record += str(record['ENROLLMENTID']).ljust(7)
...
# SQL Query
select = "SELECT * FROM STUCENTR.ENROLLMENT"

# Execute the query
stmt = ibm_db.exec_immediate(conn, select)

# Local file for saving query results
local_file = '/home/linux1/WCSIBM/python/data-trans/output/enrollment_data.txt'
...
remote_file_path = '/z/z41780/WCS-IBM/data/enrollment_data.txt'
