...
# SQL Query
select = "SELECT * FROM STUCENTR.LABENROLLMENT"

# Execute the query
stmt = ibm_db.exec_immediate(conn, select)

# Local file for saving query results
local_file = '/home/linux1/WCSIBM/python/data-trans/output/labenrollment_data.txt'
...
remote_file_path = '/z/z41780/WCS-IBM/data/labenrollment_data.txt'
