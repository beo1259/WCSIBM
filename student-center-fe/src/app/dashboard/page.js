      ...
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-purple-600 to-purple-400">
        <div className="p-6 max-w-4xl w-full bg-gradient-to-r from-purple-300 to-purple-100 rounded-2xl shadow-md">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* Program Status */}
            <div onClick={() => navigateTo('/program-status')} className="bg-white text-purple-800 rounded-lg p-6 shadow-lg hover:shadow-xl transition hover:text-blue-600 hover:bg-purple-200 cursor-pointer relative">
            ...
            {/* Course Registration */}
            <div onClick={() => navigateTo('/course-registration')} className="bg-white  text-purple-800 rounded-lg p-6 shadow-lg hover:shadow-xl transition hover:text-blue-600 hover:bg-purple-200 cursor-pointer relative">
            ...
            {/* Grades */}
            <div onClick={() => navigateTo('/grades')} className="bg-white text-purple-800 rounded-lg p-6 shadow-lg hover:shadow-xl transition hover:text-blue-600 hover:bg-purple-200 cursor-pointer relative transition duration-150 ease-in-out">
